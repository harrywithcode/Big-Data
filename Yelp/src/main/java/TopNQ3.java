...
public class TopNQ3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*Changed*/
        job.setJarByClass(TopNQ3.class);
    ...
    public static class TopNMapper extends Mapper<Object, Text, Text, IntWritable> {
        ...
        /****Code in maper need to change
         * I use some resource from CountYelpBusiness*****/
        @Override
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			if (businessData.length ==3) {
				String zipAddress = businessData[1].trim();
				if(zipAddress.length() < 6){
					return;
				}
				/*All zipcodes are at the last 6 in address information*/
				/*substring includes begin index, excludes end index*/
				String zipcode = zipAddress.substring(zipAddress.length()-5, zipAddress.length());
				try{
